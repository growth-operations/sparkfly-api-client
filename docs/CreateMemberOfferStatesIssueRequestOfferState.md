...
create_member_offer_states_issue_request_offer_state_instance = CreateMemberOfferStatesIssueRequestOfferState.from_json(json)
# print the JSON string representation of the object
print(CreateMemberOfferStatesIssueRequestOfferState.to_json())

# convert the object into a dict
create_member_offer_states_issue_request_offer_state_dict = create_member_offer_states_issue_request_offer_state_instance.to_dict()
# create an instance of CreateMemberOfferStatesIssueRequestOfferState from a dict
create_member_offer_states_issue_request_offer_state_from_dict = CreateMemberOfferStatesIssueRequestOfferState.from_dict(create_member_offer_states_issue_request_offer_state_dict)
```
