# sparkfly.POSOfferCodesApi

All URIs are relative to *https://api-staging.sparkfly.com/v1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_pos_code**](POSOfferCodesApi.md#get_pos_code) | **GET** /pos_offer_codes/{id} | Get a POS Offer Code
[**list_all_pos_codes**](POSOfferCodesApi.md#list_all_pos_codes) | **GET** /pos_offer_codes | List all POS Offer Codes


# **get_pos_code**
> PosOfferCode get_pos_code(id, content_type=content_type)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a POS Offer Code
        api_response = await api_instance.get_pos_code(id, content_type=content_type)
        print("The response of POSOfferCodesApi->get_pos_code:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling POSOfferCodesApi->get_pos_code: %s\n" % e)
```
...
# **list_all_pos_codes**
> PosOfferCodeIndexBody list_all_pos_codes(content_type=content_type)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # List all POS Offer Codes
        api_response = await api_instance.list_all_pos_codes(content_type=content_type)
        print("The response of POSOfferCodesApi->list_all_pos_codes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling POSOfferCodesApi->list_all_pos_codes: %s\n" % e)
```
