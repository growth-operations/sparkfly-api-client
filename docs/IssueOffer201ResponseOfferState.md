...
issue_offer201_response_offer_state_instance = IssueOffer201ResponseOfferState.from_json(json)
# print the JSON string representation of the object
print(IssueOffer201ResponseOfferState.to_json())

# convert the object into a dict
issue_offer201_response_offer_state_dict = issue_offer201_response_offer_state_instance.to_dict()
# create an instance of IssueOffer201ResponseOfferState from a dict
issue_offer201_response_offer_state_from_dict = IssueOffer201ResponseOfferState.from_dict(issue_offer201_response_offer_state_dict)
```
