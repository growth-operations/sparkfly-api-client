...
------------- | ------------- | -------------
[**create_store**](StoresApi.md#create_store) | **POST** /merchants/{merchant_id}/stores | Create a Store
[**delete_store**](StoresApi.md#delete_store) | **DELETE** /merchants/{merchant_id}/stores/{store_id} | Remove a Store
[**get_store**](StoresApi.md#get_store) | **GET** /merchants/{merchant_id}/stores/{store_id} | Retrieve a Store
[**list_stores**](StoresApi.md#list_stores) | **GET** /merchants/{merchant_id}/stores | List all Stores
[**list_stores_index**](StoresApi.md#list_stores_index) | **GET** /merchants/stores/index | List all Stores with Active Offers
[**update_store**](StoresApi.md#update_store) | **PUT** /merchants/{merchant_id}/stores/{store_id} | Update a Store


# **create_store**
> Store create_store(merchant_id, content_type=content_type, store_request=store_request)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a Store
        api_response = await api_instance.create_store(merchant_id, content_type=content_type, store_request=store_request)
...
# **delete_store**
> delete_store(store_id, merchant_id, content_type=content_type)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove a Store
        await api_instance.delete_store(store_id, merchant_id, content_type=content_type)
    except Exception as e:
...
# **get_store**
> Store get_store(store_id, merchant_id, content_type=content_type)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a Store
        api_response = await api_instance.get_store(store_id, merchant_id, content_type=content_type)
...
# **list_stores**
> StoreIndexBody list_stores(merchant_id, search_text=search_text, sort_by=sort_by, page=page, per_page=per_page, order=order)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # List all Stores
        api_response = await api_instance.list_stores(merchant_id, search_text=search_text, sort_by=sort_by, page=page, per_page=per_page, order=order)
...
# **list_stores_index**
> StoreIndexBody list_stores_index(content_type=content_type, page=page, per_page=per_page, order=order, search_text=search_text, sort_by=sort_by)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # List all Stores with Active Offers
        api_response = await api_instance.list_stores_index(content_type=content_type, page=page, per_page=per_page, order=order, search_text=search_text, sort_by=sort_by)
        print("The response of StoresApi->list_stores_index:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StoresApi->list_stores_index: %s\n" % e)
```
...
# **update_store**
> Store update_store(store_id, merchant_id, content_type=content_type, store_request=store_request)
...
async with sparkfly.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a Store
        api_response = await api_instance.update_store(store_id, merchant_id, content_type=content_type, store_request=store_request)
