...
class TestMemberAllOfMemberCredentials(unittest.TestCase):
    """MemberAllOfMemberCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberAllOfMemberCredentials:
        """Test MemberAllOfMemberCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemberAllOfMemberCredentials`
        """
        model = MemberAllOfMemberCredentials()
        if include_optional:
            return MemberAllOfMemberCredentials(
                credential = sparkfly.models.member_all_of_member_credential.member_allOf_member_credential(
                    id = 56, 
                    identifier = '', 
                    type = '', 
                    channel_id = 56, )
    ...
    def testMemberAllOfMemberCredentials(self):
        """Test MemberAllOfMemberCredentials"""
