...
class TestCreateMemberOfferStatesIssueRequest(unittest.TestCase):
    """CreateMemberOfferStatesIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMemberOfferStatesIssueRequest:
        """Test CreateMemberOfferStatesIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMemberOfferStatesIssueRequest`
        """
        model = CreateMemberOfferStatesIssueRequest()
        if include_optional:
            return CreateMemberOfferStatesIssueRequest(
                offer_state = sparkfly.models.create_member_offer_states_issue_request_offer_state.create_member_offer_states_issue_request_offer_state(
                    external_ref_id = '', 
                    campaign_id = '', 
    ...
    def testCreateMemberOfferStatesIssueRequest(self):
        """Test CreateMemberOfferStatesIssueRequest"""
