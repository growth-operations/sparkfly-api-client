...
class TestCreateMemberOfferStatesIssue201ResponseOfferState(unittest.TestCase):
    """CreateMemberOfferStatesIssue201ResponseOfferState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMemberOfferStatesIssue201ResponseOfferState:
        """Test CreateMemberOfferStatesIssue201ResponseOfferState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMemberOfferStatesIssue201ResponseOfferState`
        """
        model = CreateMemberOfferStatesIssue201ResponseOfferState()
        if include_optional:
            return CreateMemberOfferStatesIssue201ResponseOfferState(
                id = 56,
                member_id = 56,
                offer_id = 56,
                campaign_id = '',
    ...
    def testCreateMemberOfferStatesIssue201ResponseOfferState(self):
        """Test CreateMemberOfferStatesIssue201ResponseOfferState"""
