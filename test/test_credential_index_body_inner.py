...
class TestCredentialIndexBodyInner(unittest.TestCase):
    """CredentialIndexBodyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialIndexBodyInner:
        """Test CredentialIndexBodyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialIndexBodyInner`
        """
        model = CredentialIndexBodyInner()
        if include_optional:
            return CredentialIndexBodyInner(
    ...
    def testCredentialIndexBodyInner(self):
        """Test CredentialIndexBodyInner"""
