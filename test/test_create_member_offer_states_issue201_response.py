...
class TestCreateMemberOfferStatesIssue201Response(unittest.TestCase):
    """CreateMemberOfferStatesIssue201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMemberOfferStatesIssue201Response:
        """Test CreateMemberOfferStatesIssue201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMemberOfferStatesIssue201Response`
        """
        model = CreateMemberOfferStatesIssue201Response()
        if include_optional:
            return CreateMemberOfferStatesIssue201Response(
                offer_state = sparkfly.models.create_member_offer_states_issue_201_response_offer_state.create_member_offer_states_issue_201_response_offer_state(
                    id = 56, 
                    member_id = 56, 
                    offer_id = 56, 
                    campaign_id = '', 
    ...
    def testCreateMemberOfferStatesIssue201Response(self):
        """Test CreateMemberOfferStatesIssue201Response"""
