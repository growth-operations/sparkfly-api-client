...
class TestCredentialIndexBodyInnerCredential(unittest.TestCase):
    """CredentialIndexBodyInnerCredential unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialIndexBodyInnerCredential:
        """Test CredentialIndexBodyInnerCredential
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialIndexBodyInnerCredential`
        """
        model = CredentialIndexBodyInnerCredential()
        if include_optional:
            return CredentialIndexBodyInnerCredential(
                id = 56,
                identifier = '',
                member_id = 56,
                account_id = 56,
    ...
    def testCredentialIndexBodyInnerCredential(self):
        """Test CredentialIndexBodyInnerCredential"""
